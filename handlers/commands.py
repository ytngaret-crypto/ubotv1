...
def register_handlers(app):
    ...
    async def menu(_, message):
        # Owner always has access. Admin/member stay completely silent until
        # the Owner explicitly enables the dashboard permission.
        if not await command_allowed(app, message, "menu"):
            return
